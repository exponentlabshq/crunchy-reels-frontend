...
export const CONTRACTS = {
  mainnet: {
    // CineBlock NFT Contract (update after mainnet deployment)
    CINEBLOCK_ADDRESS: "",
  ...
  testnet: {
    // CineBlock NFT Contract (update after testnet deployment)
    CINEBLOCK_ADDRESS: import.meta.env.VITE_CONTRACT_ADDRESS ?? "",
    CINEBLOCK_NAME: "cineblock",
    ...
    // SIP-010 Trait
    TRAIT_ADDRESS: import.meta.env.VITE_CONTRACT_ADDRESS ?? "",
