...
function TabNavigation({ variant }: TabNavigationProps) {
    ...
    return (
      <div className="hidden lg:flex flex-col w-64 bg-background-100/50 backdrop-blur-xl border-r border-background-300/50 z-50">
        ...
        <div className="p-6 border-b border-background-300/50">
          <h1 className="text-primary-500 text-xl font-bold font-outfit tracking-tight">
            CineBlock
          </h1>
              ...
              >
                ...
                <Icon
                  className={`w-5 h-5 transition-all duration-300 ${
                    isActive ? "text-primary-500" : "text-typography-500 group-hover:text-typography-900"
                  }`}
                  strokeWidth={isActive ? 2.5 : 2}
                />
                <span
                  className={`text-sm font-medium transition-all duration-300 ${
                    isActive ? "text-primary-500 font-semibold" : "text-typography-600 group-hover:text-typography-900"
                  }`}
                >
                  {route.label}
                </span>
        ...
        <div className="p-4 border-t border-background-300/50">
          <p className="text-typography-500 text-xs text-center">
            ...
            >
              ...
              <Icon
                className={`w-6 h-6 transition-all duration-300 ${
                  isActive ? "text-primary-500 scale-110" : "text-typography-500 opacity-55 group-hover:opacity-90"
                }`}
                strokeWidth={isActive ? 2.5 : 2}
              />
              <span
