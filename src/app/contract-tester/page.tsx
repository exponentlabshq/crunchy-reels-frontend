...
import { serializeCV, deserializeCV, cvToJSON, uintCV, principalCV, tupleCV } from "@stacks/transactions";
import {
...
export default function ContractTesterPage() {
  ...
  return (
    <div className="min-h-screen flex-1 bg-background-0 overflow-y-auto pb-24 lg:pb-8">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-typography-950 font-sans">Contract Tester</h1>
              <p className="text-xs text-green-500 font-medium">
                Programming USDCx on Stacks Builder Challenge
              </p>
            </div>
          </div>
          <p className="text-typography-600">Debug and test CineBlock smart contracts powered by USDCx</p>
        </div>
        ...
        <div className="bg-background-100 border border-background-300 rounded-2xl p-4 mb-6">
          ...
          {selectedContract === "cineblock" && !CINEBLOCK_ADDRESS && (
            <div className="mt-4 flex items-center gap-2 text-orange-500 text-sm">
              ...
              <span>Contract address not configured. Set NEXT_PUBLIC_CONTRACT_ADDRESS in .env</span>
            </div>
          )}
        </div>
        ...
        <div className="bg-background-100 border border-background-300 rounded-2xl p-6 mb-6">
          ...
          {activeTab === "info" && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-typography-950 font-sans">Contract Interface</h3>
          ...
          {activeTab === "read" && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-typography-950 font-sans">Read-Only Functions</h3>
              ...
              <div className="border-t border-background-300 pt-6 space-y-4">
                ...
                {/* Check Admin */}
                <div className="bg-background-0 rounded-xl p-4 border border-background-300">
                  <label className="text-sm font-medium text-typography-700 mb-2 block">
                    Check Admin Status
                  </label>
                  <div className="flex gap-2">
                    <input
          ...
          {activeTab === "write" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-typography-950 font-sans">Write Functions</h3>
                {!isConnected && (
              ...
              <div className="bg-background-0 rounded-xl p-5 border border-background-300 space-y-4">
                <h4 className="font-medium text-typography-950 flex items-center gap-2">
                  <span className="px-2 py-0.5 bg-green-500/20 text-green-600 text-xs font-bold rounded">
                    ADMIN
                  </span>
                  <Film className="w-4 h-4" />
                  Create Film Project
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-xs text-typography-500 mb-1 block">
                      Token Price (USDCx per token)
                    </label>
                    <input
                      type="number"
              ...
              <div className="bg-background-0 rounded-xl p-5 border border-background-300 space-y-4">
                <h4 className="font-medium text-typography-950 flex items-center gap-2">
                  <span className="px-2 py-0.5 bg-orange-500/20 text-orange-500 text-xs font-bold rounded">
                    DEMO
                  </span>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setWriteForm((f) => ({
                          ...f,
                          investAmount: (parseInt(e.target.value) / 1_000_000).toString(),
                        }))
                      }
                      className="w-full bg-background-100 border border-background-300 rounded-xl px-4 py-2.5 text-typography-950 font-mono focus:outline-none focus:ring-2 focus:ring-primary-500"
                    />
          ...
          {activeTab === "maps" && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-typography-950 font-sans">Data Maps</h3>
          ...
          {activeTab === "vars" && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-typography-950 font-sans">Data Variables</h3>
          ...
          {activeTab === "usdcx" && (
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-typography-950 font-sans">USDCx Token</h3>
              ...
              <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl p-4 border border-green-500/30">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <code className="ml-2 text-typography-700 font-mono text-xs">{USDCX_ASSET_ID}</code>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background-200/50 rounded-xl p-4 border border-background-300">
                ...
                <p className="text-sm text-typography-600 mb-3">
                  USDCx is bridged from Ethereum via Circle&apos;s xReserve protocol. Deposits are initiated
                  on Ethereum and automatically minted on Stacks.
                </p>
                <a
          ...
          <div className="p-4 min-h-[200px] max-h-[400px] overflow-auto">
            ...
            {!loading && output?.success && output.txId && (
              <div className="space-y-2">
                ...
                <code className="text-xs font-mono text-typography-400 break-all block">{output.txId}</code>
              </div>
            )}
